...
Navigating our app is a breeze. The intuitive user interface allows you to quickly browse through the week's <a href="/Topics" target="_self">**top news topics**</a>. Each topic is presented with a concise summary, making it easy to decide which stories pique your interest.''', unsafe_allow_html=True)
st.write('''### Save Time
...
st.write('''For more information about the sources, please visit the <a href="/Sources" target="_self">Sources</a> page.''', unsafe_allow_html=True)
